  ...
  return (
    <div className="grid lg:grid-cols-12 gap-5 md:gap-6 items-stretch mb-12">
      ...
      >
        ...
        >
          Anggota <span className="italic text-primary">Tim KKN</span>
        </motion.h1>
        ...
        >
          Kenali lebih dekat para mahasiswa yang mengabdi dan pembagian penempatan
          wilayah tugas mereka di Desa Kawasi & Soligi.
        </motion.p>
      </motion.div>

      {/* KANAN: BLOK WARNA SOLID (tertiary) — counter anggota */}
      <motion.div
      ...
      >
        ...
        <div className="relative z-10 inline-flex items-center gap-2 bg-background border-2 border-on-surface px-3 py-1 rounded-full w-fit">
          <HeartHandshake className="w-3.5 h-3.5 text-on-surface" />
