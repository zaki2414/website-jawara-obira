...
export default function CultureCatalogError({
  error,
  unstable_retry,
}: {
  ...
  return (
    <section className="relative bg-natural-paper py-10 md:py-16 px-4 sm:px-6 md:px-8 border-b-4 border-on-surface min-h-screen flex items-center justify-center">
      <div className="w-full max-w-md text-center p-6 bg-background border-4 border-error rounded-2xl hard-shadow">
        ...
        <p className="text-body-md text-on-surface-variant mb-5">
          Arsip kebudayaan tidak dapat dimuat saat ini. Silakan coba lagi.
        </p>
        <button
          type="button"
