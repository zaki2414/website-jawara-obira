...
export default function CultureDetailError({
  error,
  unstable_retry,
}: {
  ...
  return (
    <article className="relative bg-background py-12 border-b-4 border-on-surface min-h-screen flex items-center justify-center px-6">
      <div className="w-full max-w-md text-center p-6 bg-background border-4 border-error rounded-2xl hard-shadow">
        ...
        <p className="text-body-md text-on-surface-variant mb-5">
          Terjadi kendala saat mengambil dokumentasi budaya ini. Silakan coba
          lagi.
        </p>
