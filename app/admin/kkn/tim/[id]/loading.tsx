// app/admin/kkn/tim/[id]/loading.tsx
import { Skeleton } from "@/components/ui/skeleton";

export default function KKNTeamFormLoading() {
  return (
    <main className="pb-12">
      ...
      <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
          <div className="space-y-4 rounded-2xl border-2 border-on-surface bg-background p-6 hard-shadow lg:col-span-2">
