// app/admin/kkn/proker/error.tsx — boundary bersama untuk /admin/kkn/proker
// dan /admin/kkn/proker/[id] (Next.js mewarisi error.tsx ke child segment
// kalau tidak ada yang lebih spesifik).
"use client";
...
export default function KKNProkerError({
  error,
  unstable_retry,
}: {
    ...
    <main className="flex min-h-[70vh] items-center justify-center px-4 py-12">
      <div className="w-full max-w-md rounded-2xl border-4 border-error bg-background p-6 text-center hard-shadow">
        ...
        <h2 className="mb-1.5 font-serif text-headline-md font-black text-on-surface">
          Data Program Kerja Gagal Dimuat
        </h2>
        <p className="mb-5 text-body-md text-on-surface-variant">
          Terjadi kendala saat memuat data program kerja KKN. Silakan coba lagi.
        </p>
