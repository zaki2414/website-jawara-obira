// app/admin/kkn/proker/[id]/loading.tsx
import { Skeleton } from "@/components/ui/skeleton";

export default function KKNProkerFormLoading() {
  return (
      ...
      <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
          <div className="space-y-6 rounded-2xl border-2 border-on-surface bg-background p-6 hard-shadow-md lg:col-span-2">
            ...
            <div className="grid gap-4 border-t-2 border-dashed border-outline-variant pt-6 md:grid-cols-3">
              {Array.from({ length: 3 }).map((_, i) => (
