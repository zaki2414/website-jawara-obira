// app/admin/budaya/error.tsx — boundary bersama untuk /admin/budaya dan
// /admin/budaya/[id] (Next.js mewarisi error.tsx ke child segment kalau
...
export default function AdminCultureError({
  error,
  unstable_retry,
}: {
    ...
    <main className="flex min-h-[70vh] items-center justify-center px-4 py-12">
      <div className="w-full max-w-md rounded-2xl border-4 border-error bg-background p-6 text-center hard-shadow">
        ...
        <h2 className="mb-1.5 font-serif text-headline-md font-black text-on-surface">
          Data Budaya Gagal Dimuat
        </h2>
        <p className="mb-5 text-body-md text-on-surface-variant">
          Terjadi kendala saat memuat data artikel budaya. Silakan coba lagi.
        </p>
