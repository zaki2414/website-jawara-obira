// app/admin/peta/error.tsx — boundary bersama untuk /admin/peta dan
// /admin/peta/[id] (Next.js mewarisi error.tsx ke child segment kalau
...
export default function AdminPetaError({
  error,
  unstable_retry,
}: {
    ...
    <main className="flex min-h-[70vh] items-center justify-center px-4 py-12">
      <div className="w-full max-w-md rounded-2xl border-4 border-error bg-background p-6 text-center hard-shadow">
        ...
        <p className="mb-5 text-body-md text-on-surface-variant">
          Terjadi kendala saat memuat data fasilitas umum. Silakan coba lagi.
        </p>
